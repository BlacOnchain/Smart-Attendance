...
<head>
    ...
    <style>
        ...
        * { font-family: 'IBM Plex Sans', system-ui, sans-serif; }
        ...
        @media (max-width: 1023px) { .auth-layout { display: flex; flex-direction: column; } .auth-form-pane { min-height: 100svh; padding-top: 6.2rem !important; } .auth-art-pane { min-height: 360px; padding: 3.5rem 1.5rem !important; } .auth-art-pane .text-5xl, .auth-art-pane h2 { font-size: 2.4rem; } .auth-art-pane .grid { display: none; } }
        @media (max-width: 520px) { .auth-back { width: 54px; height: 54px; top: 0; left: 8px; font-size: 32px; } .auth-form-pane { padding-left: 1.35rem !important; padding-right: 1.35rem !important; } }
