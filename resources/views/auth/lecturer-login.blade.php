...
<head>
    ...
    <style>
        ...
        * { font-family: 'IBM Plex Sans', system-ui, sans-serif; }
        ...
        /* Unified emerald glass auth system. */
        body.auth-page { background: linear-gradient(160deg, #e9f4ec 0%, #f6f8f2 48%, #eef6f1 100%); }
        .auth-layout { max-width: none; }
        .auth-back { position: fixed; z-index: 30; top: 18px; left: 20px; display: grid; place-items: center; width: 62px; height: 62px; border-radius: 0 0 18px 0; background: #fff; color: #10201a; font-size: 38px; line-height: 1; box-shadow: 0 8px 22px rgba(16,32,26,.08); transition: transform .2s ease; }
        .auth-back:hover { transform: translateX(-3px); }
        .auth-form-pane { background: #10201a; color: #f8fafc; }
        ...
        .auth-form-pane .tag-badge { color: #a7f3d0; background: transparent; border: 0; padding: 0; font-size: 12px; text-transform: uppercase; letter-spacing: .2em; }
        ...
        .auth-form-pane .btn-nudge { border-radius: 8px; background: #059669 !important; box-shadow: 0 12px 24px rgba(5,150,105,.22); }
        .auth-form-pane .btn-nudge:hover { background: #047857 !important; }
        .auth-form-pane a { color: #6ee7b7 !important; }
        .auth-form-pane a:hover { color: #a7f3d0 !important; }
        ...
        .auth-art-pane::before, .auth-art-pane::after { content: ''; position: absolute; border-radius: 999px; background: rgba(255,255,255,.11); pointer-events: none; }
        ...
        .auth-art-pane .tag-badge { color: rgba(255,255,255,.82); background: transparent; border: 0; padding: 0; }
        ...
        .auth-art-pane .glass-chip p { color: rgba(255,255,255,.75) !important; }
        .auth-art-visual { display: flex; align-items: center; gap: 2rem; margin: 1.5rem 0; }
        ...
        .auth-visual-orbit::after { content: ''; position: absolute; inset: 0; border: 1px dashed rgba(255,255,255,.2); border-radius: 50%; }
        .auth-art-visual img { width: 78%; height: 78%; object-fit: contain; position: relative; z-index: 1; filter: drop-shadow(0 24px 24px rgba(4,78,55,.25)); animation: shieldFloat 5s ease-in-out infinite; }
        ...
        .auth-progress span { display: block; width: 92%; height: 100%; border-radius: inherit; background: #a7f3d0; }
        .auth-preview-card > div:last-child { display: flex; justify-content: space-between; gap: .5rem; margin-top: .65rem; color: #a7f3d0; font-size: .65rem; }
        ...
        @media (max-width: 1023px) { .auth-layout { display: flex; flex-direction: column; } .auth-form-pane { min-height: 100svh; padding-top: 6.2rem !important; } .auth-art-pane { min-height: 360px; padding: 3.5rem 1.5rem !important; } .auth-art-pane .grid { display: none; } }
        @media (max-width: 520px) { .auth-back { width: 54px; height: 54px; top: 0; left: 8px; font-size: 32px; } .auth-form-pane { padding-left: 1.35rem !important; padding-right: 1.35rem !important; } .auth-art-visual { gap: .8rem; } .auth-visual-orbit { width: 135px; height: 135px; } .auth-preview-card { width: 165px; } }
    </style>
</head>
            ...
            <aside class="hidden lg:flex lg:flex-col lg:justify-between lg:px-14 lg:py-14 auth-art-pane">
                ...
                <div class="auth-art-visual anim-scale" style="--d: 0.18s">
                    ...
                    <div class="auth-preview-card">
                        <p>Live session status</p>
                        <strong>Ready</strong>
                        <div class="auth-progress"><span></span></div>
                        <div><span>QR check-in</span><b>Protected</b></div>
                    </div>
                </div>
