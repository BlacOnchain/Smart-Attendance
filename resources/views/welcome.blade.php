...
<body class="bg-white text-slate-900 min-h-screen relative overflow-x-hidden font-sans">
    ...
    <section class="mx-auto max-w-5xl px-6 pt-20 pb-16 text-center">
        <div class="inline-flex items-center gap-2 rounded-full bg-emerald-50 px-4 py-1.5 text-xs font-bold text-emerald-800 border border-emerald-200/60 mb-6">
        ...
        <p class="mt-6 text-lg sm:text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed">
            Eliminate proxy sign-ups and paper registers. Automatically generate verified academic timelines and course logs from real-time student check-ins.
        </p>
    ...
    <!-- Feature Section 01: Rolling QR Tokens (Zipper Layout) -->
    <section class="mx-auto max-w-6xl px-6 py-20 border-t border-slate-100">
        <div class="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div class="feature-card rounded-3xl p-6 bg-slate-50/50 border border-slate-200">
    ...
    <!-- Feature Section 02: Automated Course Registration Forms -->
    <section class="mx-auto max-w-6xl px-6 py-20 border-t border-slate-100">
        <div class="grid md:grid-cols-2 gap-12 items-center">
            <div class="feature-card rounded-3xl p-6 bg-slate-50/50 border border-slate-200 order-2 md:order-1">
                <div class="flex items-center justify-between pb-4 border-b border-slate-200">
                ...
                <div class="py-6 space-y-3">
                    <div class="flex items-center gap-4 bg-white p-4 rounded-2xl border border-slate-200">
                        <div class="h-12 w-12 rounded-xl bg-emerald-600 text-white font-bold flex items-center justify-center">AO</div>
                        <div>
                            <p class="font-bold text-sm text-slate-900">Odubela Oluwatomiwa</p>
    ...
    <!-- Feature Section 03: Telemetry & Attendance Reports -->
    <section class="mx-auto max-w-6xl px-6 py-20 border-t border-slate-100">
        <div class="grid md:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <p class="mt-4 text-slate-600 leading-relaxed text-sm sm:text-base">
                    Lecturers gain complete visibility into student attendance histories. Monitor attendance trends across semesters, inspect individual student logs, and export tidy records whenever required.
                </p>
            </div>
            <div class="feature-card rounded-3xl p-6 bg-slate-50/50 border border-slate-200">
                <div class="space-y-3">
    ...
    <!-- Footer -->
    <footer class="border-t border-slate-200 py-10 text-center text-xs text-slate-500 bg-slate-50">
        <p>&copy; 2026 Smart Attendance University. All rights reserved.</p>
    </footer>
